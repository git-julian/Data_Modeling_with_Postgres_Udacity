...
def process_log_file(cur, filepath):
    ...
    '''
    Reas in JSON files that hold information from the log files.
    The data is extracted and transformed into the needed database 
    schema for the tabels time, user and songplay data.
